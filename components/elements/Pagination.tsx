...
export default function Pagination() {
    return (
        <section className="pb-120 bg-secondary-2">
                        ...
                        <nav aria-label="Page navigation example">
                            <ul className="pagination gap-2">
                                <li className="page-item">
                                    <Link className="icon-md bg-white fs-5 page-link pagination_item border-0 icon-shape fw-regular" href="#" aria-label="Previous">
                                ...
                                <li className="page-item">
                                    <Link className="icon-md bg-white fs-5 page-link pagination_item border-0 icon-shape fw-regular" href="#">
                                        1
                                    </Link>
                                </li>
                                <li className="page-item">
                                    <Link className="icon-md bg-white fs-5 page-link pagination_item border-0 icon-shape fw-regular active" href="#">
                                        2
                                    </Link>
                                </li>
                                <li className="page-item">
                                ...
                                <li className="page-item">
                                    <Link className="icon-md bg-white fs-5 page-link pagination_item border-0 icon-shape fw-regular" href="#" aria-label="Next">
                                        <svg xmlns="http://www.w3.org/2000/svg" width={22} height={22} viewBox="0 0 22 22" fill="none">
